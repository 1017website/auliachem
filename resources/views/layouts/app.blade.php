...
<head>
    ...
    <title>@yield('title', 'CRM') - {{ \App\Models\Setting::get('company_name', 'Chemical CRM') }}</title>
    ...
    <aside class="sidebar" id="sidebar">
        <a href="{{ route('dashboard') }}" class="sidebar-brand">
            ...
            @else
                <div class="brand-icon">
                    <i class="fas fa-flask text-white" style="font-size:.85rem"></i>
                </div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('deletion-requests.index') }}" class="sidebar-item {{ request()->routeIs('deletion-requests.*') ? 'active' : '' }}">
                ...
                @php
                    $pendingDeletionCount = \App\Models\DeletionRequest::pendingCount();
                @endphp
