...
@php
    ...
    $signerRole = $po->salesUser?->role ?? 'Administrator';
@endphp
...
<main class="page">
    ...
    <section class="document-heading">
        ...
        <table class="meta">
            <tr><td>Tanggal</td><td>{{ $po->order_date?->translatedFormat('d F Y') }}</td></tr>
    ...
    <section class="parties">
        ...
        <div>
            <div class="party-title">DIKIRIM KE</div>
    ...
    <table class="items">
        <thead><tr><th style="width:36px">NO</th><th>DESKRIPSI</th><th style="width:62px">UNIT</th><th style="width:82px">QTY</th><th style="width:120px">HARGA / UNIT</th><th style="width:125px">JUMLAH</th></tr></thead>
        <tbody>
    ...
    <section class="bottom">
        <div class="instructions"><b>Instruksi Khusus</b><div>{{ $po->special_instructions ?: ($po->notes ?: '-') }}</div></div>
    ...
    <div class="footer">Jika ada pertanyaan mengenai purchase order ini, silakan hubungi {{ $settings['company_phone'] ?? 'kantor kami' }}.</div>
</main>
</body>
</html>
