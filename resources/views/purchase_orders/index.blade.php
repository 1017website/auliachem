    ...
    @push('scripts')
        <script>
            ...
            function addItemRow(bodyId, data = {}) {
                ...
                <td><input type="hidden" name="${prefix}[${idx}][qty]" class="item-qty-hidden" value="${data.qty || ''}"><input type="text" inputmode="decimal" class="form-control form-control-sm item-qty text-end" value="${data.qty ? formatQuantity(data.qty) : ''}" placeholder="1.000,500" title="Titik untuk ribuan, koma untuk desimal" required oninput="syncQuantity(this);calcRow(this)"></td>
                <td>
