...
<main class="page">
    <header @class(['letterhead', 'split-letterhead', 'quotation-letterhead' => $isQuotation])>
        ...
        <div class="split-company-info">
            ...
            @if(!$isQuotation && !empty($settings['company_address']))<div><b>Address</b>: <span>{!! nl2br(e($settings['company_address'])) !!}</span></div>@endif
            @if(!$isQuotation && !empty($settings['company_phone']))<div><b>Phone</b>: {{ $settings['company_phone'] }}</div>@endif
