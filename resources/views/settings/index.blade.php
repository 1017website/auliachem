        ...
        <div class="col-md-9">
            ...
            <div class="settings-card d-none" id="sec-general">
                ...
                <form action="{{ route('settings.update') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">Prefix Nomor &amp; Nama File Dokumen</label>
                            ...
                            <div style="font-size:11px;color:#9ca3af;margin-top:3px">
                                Kode nomor dan nama file: <strong>AP1</strong> Penawaran, <strong>AP2</strong> Invoice, dan <strong>AP3</strong> Purchase Order. Nomor urut atau timestamp ditambahkan otomatis.
                            </div>
                        </div>
                        <div class="col-md-6">
