...
<div class="row g-3 mb-4">
    <div class="col">
        <div class="kpi-card">
            <div class="kpi-icon" style="background:var(--primary-light)"><i class="fas fa-chart-bar" style="color:var(--primary)"></i></div>
            <div>
    ...
    if (pipelinePieEl && window.Chart) {
        ...
        options: {
            plugins: {
                ...
                tooltip: {
                    callbacks: {
                        label: ctx => ` ${ctx.label}: Rp ${ctx.parsed.toLocaleString('id-ID', {minimumFractionDigits: 0, maximumFractionDigits: 3})} Jt`
                    }
                }
            },
            cutout: '65%',
