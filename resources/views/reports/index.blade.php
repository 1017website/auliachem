                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="search" class="form-control"
                                    placeholder="Cari nama company, nomor PO..." value="{{ $search }}">
                            </div>
                ...
                <div class="card h-100">
                    <div class="card-body p-3">
                        ...
                        <a href="{{ route('reports.export', array_merge(request()->query(), ['report_type' => $reportType])) }}"
                            ...
                            style="border:1px solid #bbf7d0;border-radius:8px;text-decoration:none;color:#16a34a;background:#f0fdf4;font-size:13px;font-weight:500">
                            <i class="fas fa-file-excel" style="font-size:16px"></i> Export Excel
                        </a>
                        <button type="button" onclick="window.print()" class="d-flex align-items-center gap-2 p-2 w-100"
                            style="border:1px solid #bfdbfe;border-radius:8px;color:#2563eb;background:#eff6ff;font-size:13px;font-weight:500;cursor:pointer">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center">
            <div>
                <div style="font-size:18px;font-weight:700;color:#1e3a5f">
                    {{ \App\Models\Setting::get('company_name', 'Chemical CRM') }}</div>
                <div style="font-size:13px;color:#6b7280;margin-top:2px">Laporan:
                    <strong>{{ ['sales' => 'Sales Report', 'customer' => 'Customer Report', 'pipeline' => 'Pipeline Report', 'performance' => 'Performance Report', 'po' => 'PO Report'][$reportType] ?? $reportType }}</strong>
                </div>
            </div>
    ...
    <div class="card">
        <div class="d-flex align-items-center justify-content-between p-3 pb-0">
            ...
            @endif
                        ...
                        <thead><tr>
                            ...
                            @forelse($reportData as $i => $lead)
                                <tr>
                                    ...
                                    <td style="font-size:12px">{{ $lead->salesUser?->name ?? '-' }}<
                                        /td>
                                    <td>
                ...
                <table c    lass="table report-table mb-0">
                    <thead><    tr>
                        ...
                        <th>    Service</th><th>Volume Est.</th><th>Revenue</th><th>Probability</th><th>Sales PIC</th><th>Last Updated</th>
                            ...
                            @forelse($reportData as $i => $lead)
                                ...
                                <tr>    
                                        ...
                                        <td style="color:#9ca3af;font-size:12px">{{ $reportData->firstItem() + $i }}</td>
                                        <td>
                                            <a href="{{ route('leads.show', $lead) }}" style="font-weigh
                                            t:600;color:#0f1d35;text-decoration:none;font-size:13px">{{ $lead->company_name }}</a>
